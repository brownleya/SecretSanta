...
<body>
    ...
    <div class="reset">
        ...
        <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Reset" CssClass="btnReset" /><br />
        <br />
        <asp:Label ID="lblmessage" runat="server"></asp:Label><br />
        <asp:HyperLink runat="server" ID="linkReturn" Text="Return to Login Page" NavigateUrl="~/secretsanta/default.aspx"></asp:HyperLink>
    </div>
    </form>
</body>
</html>
